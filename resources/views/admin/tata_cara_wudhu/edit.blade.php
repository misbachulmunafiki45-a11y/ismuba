            ...
            <form action="{{ route('admin.wudhu.readings.update', $reading) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="arabic" name="arabic" class="form-control" rows="2">{{ old('arabic', $reading->arabic) }}</textarea>
                    </div>
                    <div class="form-group">
                        <label for="latin">Latin <span class="text-muted">(opsional)</span></label>
                        <input id="latin" name="latin" type="text" class="form-control" value="{{ old('latin', $reading->latin) }}" />
                    </div>
                    <div class="form-group">
